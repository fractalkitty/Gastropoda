//part of december adventure: https://sluggly.art/

//inspired by NAGASAWA ROSETSU's slug piece (https://commons.wikimedia.org/wiki/File:Nagasawa_Rosetsu_Slug.jpg)
...
function draw() {
  if (!playBool && frameCount < 2) {
    triangle(width / 2, height / 2, width / 2, height / 2 + 20, width / 2 + 20, height / 2 + 10)
  }
